# /*
#  * @Author: yaohua.zang 
#  * @Date: 2023-09-21 20:37:51 
#  * @Last Modified by:   yaohua.zang 
#  * @Last Modified time: 2023-09-21 20:37:51 
#  */
import numpy as np 
import torch 
...
class Problem():
    ...
    def tRely(self):
        '''
        The problem depents on time or not.
        '''
        return True
    ...
    def strong(self, model_u, xs:torch.tensor, t:torch.tensor, 
               stretch:float=1.)->torch.tensor:
        '''
        The strong form
        Input: model_u
                    x:size(?,d)
